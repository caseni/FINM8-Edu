...
const lessons = [{ key: 'zones', title: 'Fiyat neden bazı bölgelerde tekrar durur' }, { key: 'momentum', title: 'Hareket neden bazen hızlanır, bazen yavaşlar' }, { key: 'average', title: 'Grafikteki yardımcı çizgi geleceği bilir mi' }];
const legacySelectors = ['[aria-label="chart-zone-single-line"]','[aria-label="chart-zone-reaction-area"]','[aria-label="chart-zone-hard-wall"]','[aria-label="chart-momentum-fast"]','[aria-label="chart-momentum-slow"]','[aria-label="chart-average-short"]','[aria-label="chart-average-long"]'];
