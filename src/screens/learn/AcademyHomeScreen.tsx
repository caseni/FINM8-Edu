...
const styles = StyleSheet.create({
  ...
  starterOptions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 2 },
  starterOptionsWide: { flexDirection: 'row', flexWrap: 'wrap' },
  starterOption: { width: '48.7%', minHeight: 74, flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 11, paddingVertical: 10, borderRadius: 14, backgroundColor: '#0D2933', borderWidth: 1, borderColor: '#28515A' },
  starterOptionWide: { width: '32.4%', minHeight: 68 },
  starterOptionPressed: { backgroundColor: '#12343D' },
  starterOptionCopy: { flex: 1, gap: 2 },
  starterOptionTitle: { color: '#F8FAFC', fontSize: 13, lineHeight: 17, fontWeight: '800' },
  starterOptionMeta: { color: '#83A5B1', fontSize: 9, lineHeight: 13, fontWeight: '700' },
