...
const createStyles = (theme: LearningTheme) => StyleSheet.create({
  ...
  optionSelected: { borderColor: theme.colors.primary, backgroundColor: theme.colors.primaryMuted },
  optionCorrect: { borderColor: theme.colors.success, backgroundColor: theme.colors.successMuted },
  optionWrong: { borderColor: theme.colors.risk, backgroundColor: theme.colors.riskMuted },
  ...
  explanationCard: { gap: 7, padding: theme.spacing.md, borderRadius: theme.radius.medium, borderWidth: 1 },
  explanationCorrect: { borderColor: theme.colors.success, backgroundColor: theme.colors.successMuted },
  explanationWrong: { borderColor: theme.colors.warning, backgroundColor: theme.colors.warningMuted },
  ...
  explanationWhy: { color: theme.colors.text, fontSize: 14, lineHeight: 20, fontWeight: '650' },
  ...
  buttonText: { color: theme.colors.buttonText, fontSize: 15, fontWeight: '900' },
