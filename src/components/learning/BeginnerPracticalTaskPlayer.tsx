...
const createStyles = (theme: LearningTheme) => StyleSheet.create({
  ...
  choiceSelected: { borderColor: theme.colors.primary, backgroundColor: theme.colors.primaryMuted },
  choiceCorrect: { borderColor: theme.colors.success, backgroundColor: theme.colors.successMuted },
  choiceWrong: { borderColor: theme.colors.risk, backgroundColor: theme.colors.riskMuted },
  ...
  feedbackCard: { gap: 5, padding: theme.spacing.md, borderRadius: theme.radius.medium, borderWidth: 1 },
  feedbackPassed: { borderColor: theme.colors.success, backgroundColor: theme.colors.successMuted },
  feedbackRetry: { borderColor: theme.colors.warning, backgroundColor: theme.colors.warningMuted },
  ...
  feedbackText: { color: theme.colors.text, fontSize: 14, lineHeight: 20, fontWeight: '650' },
