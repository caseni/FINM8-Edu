...
const createStyles = (_theme: LearningTheme) => StyleSheet.create({
  shell:{width:'100%',minHeight:210,borderRadius:18,borderWidth:1,borderColor:'#24465C',backgroundColor:'#081725',padding:14,justifyContent:'center',overflow:'hidden'},
