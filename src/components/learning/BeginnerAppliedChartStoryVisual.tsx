...
const createStyles = (theme: LearningTheme, wide: boolean, phone: boolean) => StyleSheet.create({
  ...
  futureCompare: { flexDirection: 'row', alignItems: 'center', gap: phone ? 8 : 12 },
  ...
  futureArrow: { color: '#718895', fontSize: phone ? 26 : 32, fontWeight: '900' },
  futureUnknown: { width: phone ? 92 : 116, minHeight: wide ? 150 : phone ? 116 : 132, alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 13, borderWidth: 1, borderStyle: 'dashed', borderColor: '#596873', backgroundColor: '#111E29' },
