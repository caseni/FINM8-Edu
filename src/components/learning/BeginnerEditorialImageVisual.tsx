...
const beginnerEditorialImages: readonly BeginnerEditorialImageEntry[] = [
  {
    ...
    role: 'hook',
    source: require('../../../assets/learning/beginner/markets/price-formation-editorial-hook.webp'),
    aspectRatio: 1.5,
  ...
  },
  {
    ...
    role: 'hook',
    source: require('../../../assets/learning/beginner/markets/liquidity-editorial-hook.webp'),
    aspectRatio: 1.5,
    compactAspectRatio: 1.5,
    resizeMode: 'cover',
    desktopMaxWidth: 520,
