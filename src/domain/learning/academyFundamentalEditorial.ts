...
const COPY: Readonly<Record<string, LessonCopy>> = {
  'lesson.fundamental.statements.001': {
    ...
    takeaway: p('Kârı, varlık-borç durumunu ve gerçek nakdi birlikte oku.', 'To understand a company, ask three questions together: What did it earn? What does it own and owe? Where did the cash actually go?'),
  ...
  'lesson.fundamental.debt-liquidity.001': {
    ...
    misconception: p('Borç miktarı tek başına yetmez; vade ve ödeme gücü sonucu değiştirir.', '“It has debt” or “it has little debt” is not enough by itself. Debt maturity and the company’s ability to pay can change the picture.'),
