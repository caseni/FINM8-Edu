...
> = {
  ...
  'market.venues.exchanges': {
    key: 'market.venues.exchanges',
    category: 'market_foundations',
    titleTr: 'Borsa ve işlem yerleri',
    titleEn: 'Exchanges and trading venues',
  },
  'market.indices.basics': {
    key: 'market.indices.basics',
    category: 'market_foundations',
    titleTr: 'Endekslerin temel mantığı',
    titleEn: 'Index foundations',
  },
  'market.etf.basics': {
    key: 'market.etf.basics',
    category: 'market_foundations',
    titleTr: 'ETF temelleri',
    titleEn: 'ETF foundations',
  },
  'market.fixed_income.bonds': {
    key: 'market.fixed_income.bonds',
    category: 'market_foundations',
    titleTr: 'Tahvil ve sabit getirili piyasalar',
    titleEn: 'Bonds and fixed income',
  },
  'market.forex.basics': {
    key: 'market.forex.basics',
    category: 'market_foundations',
    titleTr: 'Forex piyasasının temel mantığı',
    titleEn: 'Forex market foundations',
  },
  'market.commodities.basics': {
    key: 'market.commodities.basics',
    category: 'market_foundations',
    titleTr: 'Emtia piyasalarının temel mantığı',
    titleEn: 'Commodity market foundations',
  },
  'market.crypto.basics': {
    key: 'market.crypto.basics',
    category: 'market_foundations',
    titleTr: 'Kripto piyasalarının temel yapısı',
    titleEn: 'Crypto market foundations',
  },
  'market.sessions.basics': {
    key: 'market.sessions.basics',
    category: 'market_foundations',
    titleTr: 'Piyasa seansları ve işlem saatleri',
    titleEn: 'Market sessions and trading hours',
  },
  'market.volume.basics': {
    key: 'market.volume.basics',
    category: 'market_foundations',
    titleTr: 'İşlem hacmi temelleri',
    titleEn: 'Trading volume foundations',
  },
  'market.liquidity_providers': {
    key: 'market.liquidity_providers',
    category: 'market_execution',
    titleTr: 'Market maker ve likidite sağlayıcılar',
    titleEn: 'Market makers and liquidity providers',
  },
  'market.primary_secondary': {
    key: 'market.primary_secondary',
    category: 'market_foundations',
    titleTr: 'Birincil ve ikincil piyasalar',
    titleEn: 'Primary and secondary markets',
  },
  'market.derivatives.basics': {
    key: 'market.derivatives.basics',
    category: 'market_foundations',
    titleTr: 'Türev ürünlerin temel mantığı',
    titleEn: 'Derivatives foundations',
  },
  'market.technical.breakout': {
    key: 'market.technical.breakout',
    category: 'market_structure',
    titleTr: 'Breakout kalitesi ve teyidi',
    titleEn: 'Breakout quality and confirmation',
  },
  'market.technical.false_breakout': {
    key: 'market.technical.false_breakout',
    category: 'market_structure',
    titleTr: 'False breakout',
    titleEn: 'False breakout',
  },
  'market.technical.pullback': {
    key: 'market.technical.pullback',
    category: 'chart_literacy',
    titleTr: 'Pullback ve trend dönüşü ayrımı',
    titleEn: 'Pullbacks versus reversals',
  },
  'market.technical.range': {
    key: 'market.technical.range',
    category: 'market_structure',
    titleTr: 'Range ve konsolidasyon',
    titleEn: 'Ranges and consolidation',
  },
  'market.technical.momentum': {
    key: 'market.technical.momentum',
    category: 'chart_literacy',
    titleTr: 'Momentum',
    titleEn: 'Momentum',
  },
  'market.technical.moving_average': {
    key: 'market.technical.moving_average',
    category: 'chart_literacy',
    titleTr: 'Hareketli ortalamalar',
    titleEn: 'Moving averages',
  },
  'risk.volatility': {
    key: 'risk.volatility',
    category: 'risk',
