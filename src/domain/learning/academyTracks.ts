...
export const ACADEMY_TRACKS: Readonly<Record<AcademyTrackId, AcademyTrackDefinition>> = {
  ...
  market_psychology: { id: 'market_psychology', order: 6, title: { tr: 'Piyasa Psikolojisi', en: 'Market Psychology' }, description: { tr: 'Core’daki FOMO, aşırı işlem ve confirmation bias bilgisini; kayıptan kaçınma, çapalama, recency, aşırı güven, revenge trading ve sonuç yanlılığıyla derinleştir.', en: 'Build on Core FOMO, overtrading, and confirmation bias with loss aversion, anchoring, recency, overconfidence, revenge trading, and outcome bias.' }, status: 'active', lessonIds: [...MARKET_PSYCHOLOGY_FOUNDATION_LESSONS.map((lesson) => lesson.id)] },
