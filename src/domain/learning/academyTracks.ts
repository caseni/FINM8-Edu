...
export const ACADEMY_TRACKS: Readonly<Record<AcademyTrackId, AcademyTrackDefinition>> = {
  ...
  algo_quant: { id: 'algo_quant', order: 8, title: { tr: 'Algoritmik Trade ve Quant', en: 'Algorithmic Trading and Quant' }, description: { tr: 'Olasılıksal düşünme, expectancy, win rate/payoff dengesi, backtest, out-of-sample doğrulama ve işlem maliyetlerini sistematik araştırmanın temeli olarak öğren.', en: 'Learn probabilistic thinking, expectancy, win-rate/payoff balance, backtesting, out-of-sample validation, and transaction costs as foundations of systematic research.' }, status: 'active', lessonIds: [...ALGO_QUANT_FOUNDATION_LESSONS.map((lesson) => lesson.id)] },
