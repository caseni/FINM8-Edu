...
const volatility = createFoundationLesson({
  ...
  title: 'Volatilite neyi ölçer, neyi söylemez?', objective: 'Fiyat hareket genişliğinin pozisyon riskini nasıl etkilediğini açıklar.', minutes: 4,
  hook: 'Fiyatın hızlı hareket etmesi yönü mü, hareketin büyüklüğünü mü anlatır?',
  ...
  takeaway: 'Volatilite yönü söylemez; hareket genişliğini ve pozisyonun taşıyabileceği dalgalanmayı anlamaya yardım eder.',
