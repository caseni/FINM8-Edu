...
const lossAversion = createFoundationLesson({
  ...
  objective: 'Aynı büyüklükteki kaybın psikolojik etkisinin kazançtan daha ağır hissedilebilmesini ve bunun karar kurallarını bozabileceğini açıklar.',
  ...
  explanation: 'Kayıptan kaçınma, insanların kayıplara benzer büyüklükteki kazançlardan daha güçlü tepki verme eğilimidir. Piyasada bu eğilim; zararı kabul etmemek, planı bozmak veya yalnız kayıp yaşamamak için gereğinden fazla risk almak gibi davranışlara dönüşebilir.',
  ...
  misconception: 'Yaygın hata: Zararı kapatmamak için beklemenin otomatik olarak sabırlı ve disiplinli davranış olduğunu sanmak.',
  misconceptionEn: 'Common mistake: assuming that refusing to close a loss is automatically patience or discipline.',
  takeaway: 'Kayıptan kaçınma, planı kaybı hissetmemek için değiştirdiğin anda karar kalitesini bozabilir.',
...
const anchoring = createFoundationLesson({
  ...
  objective: 'İlk fiyat, hedef veya görüşün sonraki değerlendirmeleri gereğinden fazla etkileyebilmesini açıklar.', objectiveEn: 'Explain how an initial price, target, or opinion can exert too much influence on later judgments.', minutes: 5,
  ...
  explanation: 'Çapalama, ilk görülen sayı veya fikrin sonraki değerlendirmeler için gereğinden güçlü referans haline gelmesidir. Eski fiyat, analist hedefi veya kendi giriş fiyatın yeni verilerden daha önemliymiş gibi davranabilir.', explanationEn: 'Anchoring occurs when an initial number or idea becomes an overly powerful reference for later judgments. An old price, analyst target, or your own entry price can begin to matter more than new evidence.',
  ...
  misconception: 'Yaygın hata: “Daha önce 100’dü, şimdi 80; demek ki ucuz” sonucuna başka kanıt olmadan gitmek.', misconceptionEn: 'Common mistake: concluding “it was 100, now it is 80, so it must be cheap” without other evidence.',
  takeaway: 'Eski fiyat bir referanstır; değer kanıtı değildir.', takeawayEn: 'An old price is a reference point, not evidence of value.',
...
const recency = createFoundationLesson({
  ...
  objective: 'Yakın geçmişteki olayların daha eski ama ilgili verilerden gereğinden fazla ağırlık almasını ayırt eder.', objectiveEn: 'Distinguish when recent events receive too much weight compared with older but relevant evidence.', minutes: 5,
  ...
  explanation: 'Recency bias, en yeni olayların zihinde daha erişilebilir olduğu için gereğinden fazla önemli görünmesidir. Son birkaç kazanç, kayıp veya haber tüm veri setini temsil etmeyebilir.', explanationEn: 'Recency bias makes the newest events feel more important because they are easier to recall. A few recent gains, losses, or headlines may not represent the full evidence set.',
  ...
  misconception: 'Yaygın hata: Son birkaç gözlemi uzun dönem davranışının güvenilir özeti sanmak.', misconceptionEn: 'Common mistake: treating the last few observations as a reliable summary of long-run behavior.',
  takeaway: 'Yeni bilgi önemlidir; ama yeni olması onu otomatik olarak en önemli bilgi yapmaz.', takeawayEn: 'New information matters, but being recent does not automatically make it the most important information.',
...
const overconfidence = createFoundationLesson({
  ...
  objective: 'Kendi tahmin doğruluğunu, bilgi kalitesini veya kontrol düzeyini olduğundan yüksek görmenin risk kararlarını nasıl bozduğunu açıklar.', objectiveEn: 'Explain how overestimating forecast accuracy, information quality, or control can distort risk decisions.', minutes: 5,
  ...
  explanation: 'Aşırı güven, kendi bilgi ve tahmin gücünü olduğundan yüksek değerlendirmektir. Kazanç serileri sonrası pozisyon büyütme, karşı kanıtı küçümseme ve belirsizliği unutma şeklinde görülebilir.', explanationEn: 'Overconfidence means overestimating your information or forecasting ability. It can appear as increasing size after a winning streak, discounting contrary evidence, or forgetting uncertainty.',
  ...
  misconception: 'Yaygın hata: Sonuçların iyi gitmesini kendi tahmin gücünün kesin arttığının kanıtı sanmak.', misconceptionEn: 'Common mistake: treating recent good outcomes as proof that forecasting skill has definitely improved.',
  takeaway: 'Güven arttığında risk kuralları gevşememeli; belirsizlik aynı şekilde ölçülmeye devam etmeli.', takeawayEn: 'When confidence rises, risk rules should not loosen; uncertainty still needs to be measured.',
...
const revengeTrading = createFoundationLesson({
  ...
  objective: 'Kayıp sonrası hızla zararı geri alma dürtüsüyle risk ve işlem kurallarının bozulmasını tanımlar.', objectiveEn: 'Identify the urge to recover a loss quickly by breaking risk and trading rules.', minutes: 5,
  ...
  explanation: 'Revenge trading, kaybın yarattığı öfke veya rahatsızlığı hızlıca silme isteğiyle plansız işlem yapmaktır. Sıklık, pozisyon büyüklüğü veya giriş standardı kaybı telafi etme hedefi yüzünden bozulabilir.', explanationEn: 'Revenge trading is unplanned trading driven by the urge to erase the discomfort or anger of a loss quickly. Frequency, position size, or entry standards can deteriorate because the goal becomes recovering the loss.',
  ...
  misconception: 'Yaygın hata: Bir kayıptan sonra hemen yeni işlem açmayı “disiplinli fırsat değerlendirme” sanmak.', misconceptionEn: 'Common mistake: treating an immediate post-loss trade as disciplined opportunity-taking without checking whether standards changed.',
  takeaway: 'Amaç zararı hemen geri almak olduğunda kararın odağı piyasadan duygusal telafiye kaymıştır.', takeawayEn: 'When the goal becomes winning the loss back immediately, the focus has shifted from the market to emotional recovery.',
...
const outcomeBias = createFoundationLesson({
  ...
  objective: 'Karar kalitesini yalnız gerçekleşen sonuç üzerinden değerlendirme hatasını ayırt eder.', objectiveEn: 'Distinguish the error of judging decision quality only by the realized outcome.', minutes: 5,
  ...
  explanation: 'Outcome bias, kararın kalitesini karar anındaki bilgi ve süreç yerine sonuca göre yargılamaktır. Belirsiz bir dünyada kötü süreç bazen iyi sonuç, iyi süreç de bazen kötü sonuç üretebilir.', explanationEn: 'Outcome bias means judging a decision by its result rather than the information and process available at the time. In an uncertain world, a poor process can sometimes produce a good outcome and a good process can sometimes produce a bad outcome.',
  ...
  misconception: 'Yaygın hata: Kâr eden plansız işlemi “doğru”, zarar eden disiplinli işlemi “yanlış” olarak etiketlemek.', misconceptionEn: 'Common mistake: labeling an unplanned winner “correct” and a disciplined loser “wrong.”',
  takeaway: 'Sonuç önemlidir ama karar kalitesinin tek ölçüsü değildir.', takeawayEn: 'Outcomes matter, but they are not the sole measure of decision quality.',
